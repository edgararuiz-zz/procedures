...
- Step 6 - Security Group Name: **Shiny** 
    ...
    **Optional: If you plan to have to publish apps from a RStudio server withi the local network (VPC)** - Click Add Rule, select Type: **All Traffic** | Source: **Custom** and enter the the first two 
